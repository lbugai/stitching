...
В основе инструмента лежит использование открытой библиотеки [SITK](https://simpleitk.org/) для поиска преобразования подобия (или другого типа), приводящего два 3D изображения в общие координаты.
