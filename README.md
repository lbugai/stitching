nlar# Инструкция по работе с прогонщиком экспериментов по совмещению трехмерных данных.
...
Преобразование совмещающее объемы является тождественнм (с некоторой точностью).
